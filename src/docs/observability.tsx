export const ObservabilityPage = () => (
  <>
    ...
    <div class="code-window docs-code">
      ...
      <div class="code-body">
        <div class="line"><span class="ln">1</span><span><span class="kw">import</span> {'{'} <span class="fn">createObservability</span> {'}'} <span class="kw">from</span> <span class="str">'honi-cf'</span></span></div>
