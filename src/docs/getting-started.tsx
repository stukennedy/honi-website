export const GettingStartedPage = () => (
  <>
    ...
    <div class="code-window docs-code">
      ...
      <div class="code-body">
        <div class="line"><span class="ln">$</span><span>npm install honi-cf</span></div>
      </div>
    </div>
    ...
    <div class="code-window docs-code">
      ...
      <div class="code-body">
        <div class="line"><span class="ln">$</span><span>npx honi-cf new my-agent</span></div>
      </div>
    </div>
    ...
    <div class="code-window docs-code">
      ...
      <div class="code-body">
        <div class="line"><span class="ln"> 1</span><span><span class="kw">import</span> {'{'} <span class="fn">createAgent</span> {'}'} <span class="kw">from</span> <span class="str">'honi-cf'</span></span></div>
